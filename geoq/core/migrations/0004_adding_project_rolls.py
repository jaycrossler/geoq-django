...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field project_admin on 'Project'
        m2m_table_name = db.shorten_name(u'core_project_project_admin')
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field project_admin on 'Project'
        db.delete_table(db.shorten_name(u'core_project_project_admin'))
    ...
    models = {
        ...
        u'core.project': {
            ...
            'project_admin': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'project_admins'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['auth.User']"}),
